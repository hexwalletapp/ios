        ...
        state.accountsData[id: accountDataKey]?
            ...
            .forEach { stake in
                ...
                case let x where x > stake.penaltyDays:
                    ...
                    state.accountsData[id: accountDataKey]?
                        .stakes[id: stake.id]?
                        .penaltyHearts = penaltyInterest.payout
                    ...
                    case (.some(let penalyBigPayDay), .some(let deltaBigPayDay)):
                        state.accountsData[id: accountDataKey]?
                            .stakes[id: stake.id]?
                            .bigPayDayHearts = penalyBigPayDay + deltaBigPayDay
                    case (.some(let penalyBigPayDay), .none):
                        state.accountsData[id: accountDataKey]?
                            .stakes[id: stake.id]?
                            .bigPayDayHearts = penalyBigPayDay
                    case (.none, .some(let deltaBigPayDay)):
                        state.accountsData[id: accountDataKey]?
                            .stakes[id: stake.id]?
